...
- Risk detection improves staff efficiency and operational control.
...
```bash
git clone https://github.com/deep1210kumar/Invoice-Intelligence-ML.git
```
...
> **Note:** `inventory.db` is not included in this repo due to size limits.
> Place it manually in the `data/` folder before running.
...
- Stack: Python, SQLite, Scikit-Learn, Streamlit
- 
